...
urlpatterns = [
    ...
    path('assessment/<int:child_id>/', views.AssessmentDashboardView.as_view(), name='assessment_dashboard'),
    ...
    path('fluency-check/<int:child_id>/word-analyze/', views.fluency_check_word_analyze, name='fluency_check_word_analyze'),
